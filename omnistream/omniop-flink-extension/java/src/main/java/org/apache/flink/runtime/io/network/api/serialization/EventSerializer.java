 ...
 *
 * <p>OmniStream extends the Flink 1.16.3 wire protocol with the COMPATIBLE savepoint format while
 * preserving the original CANONICAL and NATIVE format codes.
 */
public class EventSerializer {
    ...
    // OmniStream Flink-compatible savepoint format code, kept in sync with the C++ serializer.
    ...
    private static void encodeSavepointType(SnapshotType snapshotType, ByteBuffer buf)
        ...
        switch (savepointType.getFormatType()) {
            ...
            case NATIVE:
                ...
                break;
            case COMPATIBLE:
                buf.put(SAVEPOINT_FORMAT_COMPATIBLE);
                break;
            default:
    ...
    private static SavepointType decodeSavepointType(byte checkpointTypeCode, ByteBuffer buffer)
        ...
        } else if (formatTypeCode == SAVEPOINT_FORMAT_COMPATIBLE) {
