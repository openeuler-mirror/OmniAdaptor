...
public class StreamExecGroupWindowAggregate extends StreamExecAggregateBase {
    ...
    protected Transformation<RowData> translateToPlanInternal(
        ...
        if (emitStrategy.produceUpdates()) {
            allowedLateness = emitStrategy.getAllowLateness();
        }
    ...
    public void setGroupAggDescription(Map<String, Object> jsonMap, ExecNode execNode,
        ...
        List<String> windowPropertyTypesList = new ArrayList<>();
        for (LogicalType type : windowPropertyTypes) {
            windowPropertyTypesList.add(type.toString());
        }
    ...
    private String getExtraDescription(String oldDescription, AggregateInfoList aggInfoList, LogicalType[] accTypes,
        ...
        try {
            ...
            LOGGER.warn("getExtraDescription error", e);  // Handle the exception or log it
        }
        return jsonString;
    }
