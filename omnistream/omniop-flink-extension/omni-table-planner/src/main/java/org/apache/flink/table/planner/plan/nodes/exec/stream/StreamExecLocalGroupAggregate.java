...
public class StreamExecLocalGroupAggregate extends StreamExecAggregateBase {
    private static final Logger LOG = LoggerFactory.getLogger(StreamExecLocalGroupAggregate.class);
    ...
    protected Transformation<RowData> translateToPlanInternal(PlannerBase planner, ExecNodeConfig config) {
        ...
        transform.setDescription(getExtraDescription(oldDescription,aggInfoList,inputTransform, accTypes,
                aggValueTypes));

        return transform;
    }

    public static void setLocalGroupAggDescription(Map<String, Object> jsonMap, ExecNode execNode,
                                                                  String oldDescription, AggregateInfoList aggInfoList,
        ...
        for (DistinctInfo distinctInfo : aggInfoList.distinctInfos()) {
            ...
            distinctInfoMap.put("filterArgs", distinctInfo.filterArgs()
                    .toArray(ClassTag$.MODULE$.apply(Integer.TYPE)));
            distinctInfoMap.put("aggIndexes", distinctInfo.aggIndexes()
                    .toArray(ClassTag$.MODULE$.apply(Integer.TYPE)));
    ...
    private String getExtraDescription(String oldDescription, AggregateInfoList aggInfoList,
                                       Transformation<RowData> inputTransform, LogicalType[] accTypes,
                                       LogicalType[] aggValueTypes) {
        ObjectMapper objectMapper = JacksonMapperFactory.createObjectMapper();
        Map<String, Object> jsonMap = new LinkedHashMap<>();
        setLocalGroupAggDescription(jsonMap, this, oldDescription, aggInfoList, inputTransform, grouping, accTypes,
                aggValueTypes);
        String jsonString = "";
        try {
