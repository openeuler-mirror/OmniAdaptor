...
public class StreamConfig implements Serializable {
    ...
    private static final String OPERATOR_DESC = "operatorDescription";
    ...
    public void setJobType(int jobType) {
        config.setInteger(JOB_TYPE, jobType);
    }
    ...
    public void setOmniConf(String omniConf) {
        config.setString(OMNI_CONF, omniConf);
    }
    ...
    public void setTransitiveChainedTaskConfigsOptimized(Map<Integer, StreamConfig> chainedTaskConfigs) {
        try {
            InstantiationUtil.writeObjectToConfig(
                    chainedTaskConfigs, this.config, CHAINED_TASK_CONFIG);
        } catch (IOException e) {
    ...
    public String getDescription() {
        return this.config.getString(OPERATOR_DESC, null);
    }

    public void setDescription(String desc) {
        this.config.setString(OPERATOR_DESC, desc);
    }
