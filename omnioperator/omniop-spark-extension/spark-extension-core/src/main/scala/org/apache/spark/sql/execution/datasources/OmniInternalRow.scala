...
//  This class used to reuse the native spark interface of table
//  write to reduce the number new files. It is essentially a batch
class OmniInternalRow(val batch: ColumnarBatch) extends InternalRow {
