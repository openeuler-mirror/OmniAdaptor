...
public class OmniStreamTwoInputProcessorFactory extends StreamTwoInputProcessorFactory {
    ...
    public static <IN1, IN2> StreamMultipleInputProcessor create(
        ...
        if (input1IsSorted || input2IsSorted) {
            ...
            MultiInputSortingDataInput.SelectableSortingInputs selectableSortingInputs =
