...
public class BinaryRowDataSerializer extends AbstractRowDataSerializer<BinaryRowData> {
    ...
    public BinaryRowDataSerializer(int numFields) {
        ...
        this.inputTypes = Collections.nCopies(numFields, SC.EMPTY);
    }

    public BinaryRowDataSerializer(int numFields, List<String> inputTypes) {
        this.numFields = numFields;
        this.fixedLengthPartSize = BinaryRowData.calculateFixPartSizeInBytes(numFields);
        this.inputTypes = inputTypes;
        if (CollectionUtil.isNullOrEmpty(this.inputTypes)) {
            this.inputTypes = Collections.nCopies(numFields, SC.EMPTY);
        }
    }
    ...
    public TypeSerializer<BinaryRowData> duplicate() {
        return new BinaryRowDataSerializer(numFields, inputTypes);
    }
    ...
    public TypeSerializerSnapshot<BinaryRowData> snapshotConfiguration() {
        return new BinaryRowDataSerializerSnapshot(numFields, inputTypes);
    }
    ...
    public static final class BinaryRowDataSerializerSnapshot
        ...
        private List<String> previousInputTypes;
        ...
        BinaryRowDataSerializerSnapshot(int numFields,  List<String> inputTypes) {
            this.previousNumFields = numFields;
            this.previousInputTypes = inputTypes;
        }
        ...
        public TypeSerializer<BinaryRowData> restoreSerializer() {
            return new BinaryRowDataSerializer(previousNumFields, previousInputTypes);
        }
